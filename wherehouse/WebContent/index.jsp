                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse justify-content-end me-4" id="navbarScroll">
                                    <ul class="navbar-nav navbar-nav-scroll" style="--bs-scroll-height: 300px;">
                                        ...
                                        <li class="nav-item ">
                                            <a class=" nav-link me-5" id="nav_btn_house_rec" href="main.jsp"
                                                role="button">
                                                거주지 추천
                                            </a>
                                        </li>
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end me-4 text-end"
                                                ...
                                                <li><a class="dropdown-item nav_choose" href="main.jsp" id="gu_btn">지역구
                                                        지도</a>
                                                </li>
                                                <li><a class="dropdown-item nav_choose" href="main.jsp"
                                                        id="detail_btn">상세
                                                        지도</a>
                                                </li>
                                            </ul>
