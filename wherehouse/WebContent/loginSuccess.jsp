                    ...
                    <ul class="navbar-nav navbar-nav-scroll" style="--bs-scroll-height: 300px;">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end me-4 text-end" id="nav_btn_gu_map_dropdown">
                                <li><a class="dropdown-item nav_choose" href="main.jsp" id="gu_btn">지역구 지도</a>
                                </li>
                                <li><a class="dropdown-item nav_choose" href="main.jsp" id="detail_btn">상세
                                        지도</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu me-5 dropdown-menu-end text-end nav_btn_house_rec_dropdown" id="">
                                <li><a class="dropdown-item nav_choose" href="description.html">분석 적용 방식 페이지</a>
                                </li>
                                <hr id="navbar_hr">
