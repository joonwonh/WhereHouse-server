<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="com.model.dao.*" %>
        <%@ page import="com.model.dto.*" %>
            <% request.setCharacterEncoding("UTF-8"); String id=(String)session.getAttribute("id"); MemberDao
                dao=MemberDao.getInstance(); MemberDto dto=dao.getMember(id); %>
                            ...
                            <div id="inputBox" class="me-3 ms-3 row">
                                <div id="login-form-border" class="pt-3 pb-3">
                                    <form action="modifyOk.jsp" method="post" name="reg_frm">
                                        <div class=" mt-3 mb-1" id="modify-id"><input type="text" name="id" size="20"
                                                class="form-control" value="<%= dto.getid() %>" disabled></div>
                                        <div class="mb-1" id="modify-pw"><input type="password" name="pw" size="20"
                                                class="form-control"
                                                placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비밀번호"></div>
                                        <div class="mb-5" id="modify-pwCheck"><input type="password" name="pw_check"
                                                size="20" class="form-control"
                                                placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비밀번호 확인"></div>

                                        <div class="mb-1" id="modify-name"><input type="text" name="name" size="20"
                                                class="form-control" value="<%= dto.getname() %>" disabled></div>
                                        <div class="mb-1" id="modify-nickName"><input type="text" name="nickname"
                                                size="20" class="form-control"
                                                placeholder="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;닉네임"></div>
                                        <div class="mb-1" id="modify-tel"><input type="text" name="tel" size="20"
                                                class="form-control"
                                        ...
                                        <div id="modify-btn" class="button-login-box">
                                            <input type="button" value="회원 정보 수정"
                                                class="btn btn-primary btn-xs mt- mb-2" style="width:100%; height:60px;"
